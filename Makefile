...
# migrate create -seq -ext sql -dir ./cmd/migrate/migrations posts_create
...
# migrate -path ./cmd/migrate/migrations -database "postgres://admin:admin@localhost/social?sslmode=disable" down
